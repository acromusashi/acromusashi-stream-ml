...
public class KmeansCalculatorTest
{
    ...
    /**
     * 40000件のデータを用いて中心点の初期化を行う。 
     * 
     * @target {@link KmeansCalculator#createDataModel(List, int, int, double)}
     * @test 40000件のデータを用いて中心点の初期化が行われること
     *    condition::40000件のデータを用いて初期化を実施
     *    result::40000件のデータを用いて中心点の初期化が行われること
     */
    @SuppressWarnings("unchecked")
    @Test
    public void testCreateDataModel_40000件データ計測() throws IOException
    {
        // 準備 
        String filePath = DATA_DIR + "KmeansCalculatorTest_40000.csv";
        File targetFile = new File(filePath);
        List<String> fileContents = FileUtils.readLines(targetFile);
    ...
    /**
     * 250000件のデータを用いて中心点の初期化を行う。 
     * 
     * @target {@link KmeansCalculator#createDataModel(List, int, int, double)}
     * @test 250000件のデータを用いて中心点の初期化が行われること
     *    condition::250000件のデータを用いて初期化を実施
     *    result::250000件のデータを用いて中心点の初期化が行われること
     */
    @SuppressWarnings("unchecked")
    @Test
    public void testCreateDataModel_250000件データ計測() throws IOException
    {
        // 準備 
        String filePath = DATA_DIR + "KmeansCalculatorTest_250000.csv";
        File targetFile = new File(filePath);
        List<String> fileContents = FileUtils.readLines(targetFile);
        ...
        // 実施
        logger.info("Create Model Start");
        KmeansDataSet actual = KmeansCalculator.createDataModel(pointList, 3, 100, 0.01d);
        logger.info("Create Model End");
